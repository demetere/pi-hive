...
export const TRUSTED_TOOL_DESCRIPTORS: readonly TrustedToolDescriptor[] = Object.freeze(([
  ...
  { name: "knowledge_propose", capability: { group: "knowledge", any: ["propose"] }, topology: "any", subsystem: "knowledge", mutability: "mutating", idempotency: "operation-bound", maxOutputBytes: OUTPUT, requiresMutationQueue: true },
