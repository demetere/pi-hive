export const HIVE_TOOL_NAMES = new Set(["route_agent", "delegate_agent", "team_status", "team_conversation", "hive_sdd_status", "submit_review_verdict", "approve_plan", "plan_new", "plan_select"]);
...
// verdict tool). buildHiveTools only emits them for the eligible type.
export const TYPE_SCOPED_TOOL_NAMES = new Set(["submit_review_verdict", "approve_plan", "plan_new", "plan_select"]);
...
export const HIVE_PLANS_DIR = `${HIVE_ROOT}/plans`;
