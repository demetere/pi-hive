...
test("Pi package manifest keeps the public workflow entrypoint, major, and Linux install boundary", () => {
...
test("package includes runtime schemas, examples, docs, and prebuilt dashboard", () => {
  for (const entry of ["index.ts", "src/", "schemas/", "examples/", "ui/web/dist/", "CHANGELOG.md", "README.md", "SETUP.md", "SECURITY.md"]) assert.ok(pkg.files.includes(entry), `files[] should include ${entry}`);
