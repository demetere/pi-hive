...
const exactManifestFiles = ["LICENSE", "CHANGELOG.md", "THIRD_PARTY_NOTICES.md", "index.ts", "src/", "schemas/", "ui/web/dist/", "examples/", "scripts/check-package-budgets.mjs", "scripts/check-licenses.mjs", "README.md", "SECURITY.md", "SETUP.md"];
